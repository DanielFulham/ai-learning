...
from employees import employees  # Importing employee data from the employees module
...
def main():
    try:
        ...
        # Create a collection in the Chroma DB with the specified name and configuration
