"""RequirementAgent with WikipediaTool + trajectory middleware.

Compare against minimal_agent.py: identical prompt, same instructions,
but agent now has research capability + observability middleware +
declarative constraint on tool invocations.
"""
...
if __name__ == "__main__":
    asyncio.run(wikipedia_enhanced_agent_example())
