...
def initialize_model(model_id):
    return ChatWatsonx(
        model_id=model_id,
        url="https://us-south.ml.cloud.ibm.com",   # IBM Watsonx public endpoint
        project_id="skills-network",               # IBM Skills Network shared project
        params=PARAMETERS
        # API key injected automatically via WATSONX_API_KEY environment variable
    )
